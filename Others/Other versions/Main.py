...
#region4: XAI
xai_methods = ['TDE']#, 'Tree', 'Kernel', 'Permutation', 'Sampling', 'Partition', 'Lime']
...
xai_methods = ['Tree', 'TDE', 'Kernel', 'Permutation', 'Sampling', 'Partition', 'Lime']
# xai_methods = ['TDE']
# model_type = model_types[0]
