...
# Load the dataset
file_path = "./xai_method_model_mae_comparison.csv"
...
# plt.title("Comparison of XAI Methods based on MAE", fontweight="bold")
...
# # Rasterize bars to prevent distortion in vector PDF
